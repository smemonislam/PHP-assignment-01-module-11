                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="{{ asset('/dashboard') }}" class="btn btn-soft-secondary btn-sm rounded-pill">how to
                                    setup <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="{{ asset('/dashboard') }}" class="btn btn-soft-secondary btn-sm rounded-pill">buttons <i
                        ...
                        <div class="text-center pt-3 pb-1">
                            <a href="{{ asset('pages-search-results.html') }}" class="btn btn-primary btn-sm">View All Results
            ...
            <div class="d-flex align-items-center">
                ...
                <!-- <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="{{ asset('javascript:void(0);')}}" class="dropdown-item notify-item language" data-lang="ar"
                            title="Arabic">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                <div class="text-center empty-cart" id="empty-cart">
                                    ...
                                    <a href="{{ asset('apps-ecommerce-products.html') }}" class="btn btn-success w-md mb-3">Shop
                                        Now</a>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="text-reset">Branded
                                                    T-Shirts</a>
                                            </h6>
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="text-reset">
                                                    Borosil Paper Cup</a>
                                            </h6>
                                            <p class="mb-0 fs-12 text-muted">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="text-reset">Gray
                                                    Styled T-Shirt</a>
                                            </h6>
                                            <p class="mb-0 fs-12 text-muted">
                        ...
                        <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border"
                            ...
                            <a href="{{ asset('apps-ecommerce-checkout.html') }}" class="btn btn-success text-center w-100">
                                Checkout
                            </a>
                        </div>
                    </div>
