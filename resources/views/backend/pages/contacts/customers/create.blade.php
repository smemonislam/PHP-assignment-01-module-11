...
@section('title','IMS | Add Customer')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 mb-3 ">
                                    <!-- <div class="mb-3"> -->
                                    <label class="form-label" for="customer-company-input">Customer Company <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="customer-company-input"
