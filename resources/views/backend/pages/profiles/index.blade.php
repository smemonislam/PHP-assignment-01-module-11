        ...
        <div class="container-fluid">
            <div class="profile-foreground position-relative mx-n4 mt-n4">
                <div class="profile-wid-bg">
                    <img src="{{ asset('assets/images/ppp.jpg') }}" alt="" class="profile-wid-img" />
                </div>
            </div>
                    ...
                    <div>
                        <div class="d-flex profile-wrapper">
                            ...
                            <div class="flex-shrink-0">
                                <a href="{{asset ('profile/setting') }}" class="btn btn-success"><i
                                                                        ...
                                                                        <div class="accordion-item border-0">
                                                                            ...
                                                                            <div id="collapseOne"
                                                                                ...
                                                                                <div class="accordion-body ms-2 ps-5">
                                                                                    ...
                                                                                    vital for people to begin put 2 and
                                                                                    2 together and begin to recognize
                                                                                    your cause. Too much or too little
                                                                                    spacing, as in the example below,
                                                                                    can make things unpleasant for the
                                                                                    reader. The goal is to make your
                                                                                    text as comfortable to read as
                                                                                    possible. A wonderful serenity has
                                                                            ...
                                                                            <div id="collapseFive"
                                                                                ...
                                                                                <div class="accordion-body ms-2 ps-5">
                                                                                    <p class="text-muted mb-2"> Every
                                                                                        team project can have a velzon.
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">
                                                                                Last Update : <span
                                                                                    class="fw-semibold text-body">4 hr
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">
                                                                                Last Update : <span
                                                                                    class="fw-semibold text-body">1 hr
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">
                                                                                Last Update : <span
                                                                                    class="fw-semibold text-body">2 hr
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
