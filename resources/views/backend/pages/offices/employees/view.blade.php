                                                ...
                                                <div>
                                                    ...
                                                    <div class="hstack gap-3 flex-wrap">
                                                        <div><i class="ri-building-line align-bottom me-1"></i>
                                                            Themesbrand</div>
                                                        <div class="vr"></div>
                                                        <div>Create Date : <span class="fw-medium">15 Sep, 2021</span>
                                                        </div>
                                                        <div class="vr"></div>
                                                        <div>Due Date : <span class="fw-medium">29 Dec, 2021</span>
                                                        </div>
                                                        <div class="vr"></div>
                                ...
                                <ul class="nav nav-tabs-custom border-bottom-0" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active fw-semibold" data-bs-toggle="tab"
                                            href="{{ asset('#project-overview') }}" role="tab">
                                            Overview
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link fw-semibold" data-bs-toggle="tab" href="{{ asset('#project-documents') }}"
                                            role="tab">
                                            Documents
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link fw-semibold" data-bs-toggle="tab" href="{{ asset('#project-activities') }}"
                                            role="tab">
                                            Activities
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link fw-semibold" data-bs-toggle="tab" href="{{ asset('#project-team') }}"
                                            role="tab">
                                            Team
                                        </a>
                                    </li>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-muted">
                                                ...
                                                <p>It will be as simple as occidental in fact, it will be Occidental. To
                                                            ...
                                                            <div class="border rounded border-dashed p-2">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 overflow-hidden">
                                                                        <h5 class="fs-13 mb-1"><a href="{{ asset('#') }}"
                                        ...
                                        <div class="card-header align-items-center d-flex">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="dropdown card-header-dropdown">
                                                    <a class="text-reset dropdown-btn" href="{{ asset('#') }}"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="{{ asset('#') }}">Recent</a>
                                                        <a class="dropdown-item" href="{{ asset('#') }}">Top Rated</a>
                                                        <a class="dropdown-item" href="{{ asset('#') }}">Previous</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card header -->
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div data-simplebar style="height: 300px;" class="px-3 mx-n3 mb-2">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-13">Joseph Parker <small
                                                                class="text-muted ms-2">20 Dec 2021 - 05:47AM</small>
                                                        </h5>
                                                ...
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-13">Donald Palmer <small
                                                                class="text-muted ms-2">24 Dec 2021 - 05:20PM</small>
                                                        </h5>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-13">Alexis Clarke <small
                                                                class="text-muted ms-2">26 min ago</small></h5>
                                                        <p class="text-muted">Your <a href="{{ asset('javascript:void(0)') }}"
                                                                class="text-decoration-underline">Online Order
                                                                Support</a> provides you with the most current status of
                                                            your order. To help manage your order refer to the “Action
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-wrap gap-2 fs-16">
                                                <div class="badge fw-medium bg-secondary-subtle text-secondary">UI/UX
                                                </div>
                                                <div class="badge fw-medium bg-secondary-subtle text-secondary">Figma
                                                </div>
                                                <div class="badge fw-medium bg-secondary-subtle text-secondary">HTML
                                                </div>
                                                <div class="badge fw-medium bg-secondary-subtle text-secondary">CSS
                                                </div>
                                                ...
                                                <div class="badge fw-medium bg-secondary-subtle text-secondary">Nodejs
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end card body -->
                                                ...
                                                <div class="vstack gap-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-13 mb-0"><a href="{{ asset('#') }}"
                                                        ...
                                                        <div class="flex-shrink-0 ms-2">
                                                            <div class="d-flex gap-1">
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="{{ asset('#') }}"><i
                                                                                    class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                                                Rename</a></li>
                                                                        <li><a class="dropdown-item" href="{{ asset('#') }}"><i
                                                                                    class="ri-delete-bin-fill align-bottom me-2 text-muted"></i>
                                    ...
                                    <div class="card-body px-4">
                                        <div class="row align-items-center team-row">
                                            ...
                                            <div class="col-lg-2 col">
                                                <div class="text-end">
                                                    <a href="{{ asset('pages-profile.html') }}" class="btn btn-light view-btn">View
                                                        Profile</a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row g-0 text-center text-sm-start align-items-center mb-3">
                                ...
                                <div class="col-sm-6">
                                    <ul
                                        ...
                                        <li class="page-item disabled"> <a href="{{ asset('#') }}" class="page-link"><i
                                                    class="mdi mdi-chevron-left"></i></a> </li>
                                        <li class="page-item"> <a href="{{ asset('#') }}" class="page-link">1</a> </li>
                                        <li class="page-item active"> <a href="{{ asset('#') }}" class="page-link">2</a> </li>
                                        <li class="page-item"> <a href="{{ asset('#') }}" class="page-link">3</a> </li>
                                        <li class="page-item"> <a href="{{ asset('#') }}" class="page-link">4</a> </li>
                                        <li class="page-item"> <a href="{{ asset('#') }}" class="page-link">5</a> </li>
                                        <li class="page-item"> <a href="{{ asset('#') }}" class="page-link"><i
