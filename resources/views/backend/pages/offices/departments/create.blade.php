...
@section('title','IMS | Create Department')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 mb-3 ">
                                    <!-- <div class="mb-3"> -->
                                    <label class="form-label" for="department-title-input">Department Title <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="department-title-input"
                                        placeholder="Enter department title">
                                </div>

                                <div class="col-lg-6 mb-3 ">
                                    <label class="form-label" for="department-description-input">Department Description</label>
                                    <input type="text" class="form-control" id="department-description-input"
                                        placeholder="Enter department's description">
                                </div>
